...
a um custo de contratação e a um valor estimado de contribuição para o desempenho da equipe, avaliado por meio do modelo de Aprendizado de Máquina
desenvolvido neste estudo. Assim, a montagem de elencos pode ser vista como uma extensão do Problema da Mochila, na qual se busca selecionar
jogadores capazes de maximizar o desempenho esperado do time respeitando restrições orçamentárias e estruturais.
