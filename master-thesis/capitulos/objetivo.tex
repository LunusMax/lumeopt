...
\begin{comment}
O presente estudo tem como objetivo principal desenvolver, avaliar e 
comparar modelos de Aprendizado de Máquinas (AM) capazes de prever o 
desempenho de equipes, entendido neste trabalho como a pontuação esperada 
ao longo da competição, a partir de dados estatísticos de desempenho individual de jogadores. 
Uma vez definido o modelo preditivo com melhor desempenho, este será 
utilizado como função objetivo em modelos simples de otimização, com 
o intuito de auxiliar o processo de tomada de decisão em contratações, 
buscando identificar soluções de mercado mais adequadas para a 
composição de elencos no futebol profissional.  
\end{comment}
O presente estudo tem como objetivo principal desenvolver e validar um 
modelo de Aprendizado de Máquina (AM) capaz de prever o desempenho de 
