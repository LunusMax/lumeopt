...
A Regressão Linear (RL) é um dos métodos mais tradicionais e amplamente utilizados em aprendizado supervisionado para tarefas de regressão \cite{Geron2019}. 
Seu objetivo consiste em modelar a relação entre um conjunto de variáveis explicativas e uma variável alvo contínua por meio de uma função linear.
