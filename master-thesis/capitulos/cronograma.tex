...
A Figura~\ref{fig51} apresenta o cronograma previsto para realização das atividades. As colunas representam os meses, sendo 24 a partir do ingresso no programa. 
As atividades são representadas nas linhas. Os quadrados marcados de cor cinza representam o mês que cada atividade foi/será realizada.


\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\linewidth]{imagens/cronograma.png}
